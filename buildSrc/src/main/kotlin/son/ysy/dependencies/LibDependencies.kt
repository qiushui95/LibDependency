...
sealed class LibDependencies(
  ...
  interface Single {
     ...
     */
    object BasePopup : LibDependencies("io.github.razerdp", "BasePopup", "3.1.8",
        DependencyMethod.Implementation)
     ...
     */
    object JodaTime : LibDependencies("joda-time", "joda-time", "2.10.12",
        DependencyMethod.Implementation)
     ...
     */
    object Mmkv : LibDependencies("com.tencent", "mmkv-static", "1.2.10",
        DependencyMethod.Implementation)
     ...
     */
    object Startup : LibDependencies("androidx.startup", "startup-runtime", "1.1.0",
        DependencyMethod.Implementation)
  ...
  interface Compose {
    ...
    interface Accompanist {
      object AppcompatTheme : LibDependencies("com.google.accompanist",
          "accompanist-appcompat-theme", "0.19.0", DependencyMethod.Implementation)

      object DrawablePainter : LibDependencies("com.google.accompanist",
          "accompanist-drawablepainter", "0.19.0", DependencyMethod.Implementation)
      ...
      object NavigationAnimation : LibDependencies("com.google.accompanist",
          "accompanist-navigation-animation", "0.19.0", DependencyMethod.Implementation)

      object NavigationMaterial : LibDependencies("com.google.accompanist",
          "accompanist-navigation-material", "0.19.0", DependencyMethod.Implementation)

      object Pager : LibDependencies("com.google.accompanist", "accompanist-pager", "0.19.0",
          DependencyMethod.Implementation)

      object Permissions : LibDependencies("com.google.accompanist",
          "accompanist-permissions", "0.19.0", DependencyMethod.Implementation)

      object PlaceHolder : LibDependencies("com.google.accompanist",
          "accompanist-placeholder", "0.19.0", DependencyMethod.Implementation)

      object PlaceHolderMaterial : LibDependencies("com.google.accompanist",
          "accompanist-placeholder-material", "0.19.0", DependencyMethod.Implementation)

      object SwipeRefresh : LibDependencies("com.google.accompanist",
          "accompanist-swiperefresh", "0.19.0", DependencyMethod.Implementation)

      object SystemUiController : LibDependencies("com.google.accompanist",
          "accompanist-systemuicontroller", "0.19.0", DependencyMethod.Implementation)
    }
    ...
    interface Official {
      ...
      object Test : LibDependencies("androidx.compose.ui", "ui-test-junit4", "1.1.0-alpha06",
          DependencyMethod.AndroidTest.Implementation)

      object Ui : LibDependencies("androidx.compose.ui", "ui", "1.1.0-alpha06",
          DependencyMethod.Implementation)

      object UiTooling : LibDependencies("androidx.compose.ui", "ui-tooling",
          "1.1.0-alpha06", DependencyMethod.Implementation)
    }
  }
  ...
  interface Group {
     ...
     */
    interface Activity {
      object Core : LibDependencies("androidx.activity", "activity-ktx", "1.3.1",
          DependencyMethod.Implementation)

      object Compose : LibDependencies("androidx.activity", "activity-compose", "1.3.1",
          DependencyMethod.Implementation)
    }
     ...
     */
    interface Core {
      object Ktx : LibDependencies("androidx.core", "core-ktx", "1.7.0-rc01",
          DependencyMethod.Implementation)
     ...
     */
    interface Lifecycle {
      object Common : LibDependencies("androidx.lifecycle", "lifecycle-common", "2.4.0-rc01",
          DependencyMethod.Implementation)
     ...
     */
    interface Room {
      object Core : LibDependencies("androidx.room", "room-runtime", "2.3.0",
          DependencyMethod.Implementation)

      object Ktx : LibDependencies("androidx.room", "room-ktx", "2.3.0",
          DependencyMethod.Implementation)

      object Compiler : LibDependencies("androidx.room", "room-compiler", "2.3.0",
          DependencyMethod.Kapt)

      object Test : LibDependencies("androidx.room", "room-testing", "2.3.0",
          DependencyMethod.Test.Implementation)
    }
